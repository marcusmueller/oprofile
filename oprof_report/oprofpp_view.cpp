...
/**
 * do_create - create and insert items in the view
 */
void OprofppView::do_create(const samples_files_t * samples)
{
...
/**
 * do_destroy - clear the view
 */
void OprofppView::do_destroy()
{
	view->clear();
}
